...
$tpl_main = str_replace('<pun_title>', '
			<h1><a href="index.php">skeet<span>.wtf</span></a></h1>
		', $tpl_main);
...
if ($pun_user['csgo'] != null && $datehis1>$datehis2 ){ 
	...
	$page_statusinfo[] = '<li><span><a href="viewtopic.php?id=37">Frequently asked questions</a> • <a href="viewtopic.php?id=11">Common issues</a></span></li>';
